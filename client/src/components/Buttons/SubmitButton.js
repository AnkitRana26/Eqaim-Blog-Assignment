...
const SubmitButton = (props) => {
    return (
        <div onClick={props.submitBlog} className='buttons topCorner submitButton'><svg width="50" height="45" viewBox="0 0 42 54" fill="none" xmlns="http://www.w3.org/2000/svg">
